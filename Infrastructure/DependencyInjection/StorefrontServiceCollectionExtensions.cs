...
using e_commerce_web_customer.Infrastructure.Recommendations.Providers;
...
public static class StorefrontServiceCollectionExtensions
{
        ...
        IConfiguration configuration)
    {
        ...
        services.AddScoped<IRecommendationProvider, CompatibilityFallbackRecommendationProvider>();
        services.AddScoped<ICompatibilityRule, IphoneAccessoryCompatibilityRule>();
        services.AddScoped<ICompatibilityRule, IpadAccessoryCompatibilityRule>();
